...
var readdirAsync = function (dir) {
    return new Promise(function (resolve, reject) {
        readdir(dir, 'utf-8', function (err, files) {
            if (err) {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                files = allFiles.filter(function (file) {
                    return filter(path.resolve(file)) && file != options.file && file != "rollup.config.js";
                });
                filesToGlob = files.map(function (name) { return path.resolve(name); });
                imports = "";
                body = "";
        ...
        transform: function (code, id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            options = optionsArr.find(function (opt) { return path.resolve(opt.file) === id; });
                            if (!options)
                                return [2 /*return*/, null];
